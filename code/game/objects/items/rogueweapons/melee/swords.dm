...
/obj/item/rogueweapon/sword/bronze
	...
	desc = "A long bronze blade attached to a hilt, separated by a crossguard. The arming sword has been Beowricke's implement of war by excellence for untold generations - and this implement is the grandfather of them all, having served as an instrumental tool in tymes before even the Bloodwake. Though it lacks the gladii's girth, this arming sword still feels well-balanced for one-handed use."
...
/obj/item/rogueweapon/sword/short/saltlian
	name = "steel kodachi"
...
/obj/item/rogueweapon/sword/iron/saber
	name = "iron saber"
	desc = "An iron sabre mass produced for line infantry. Its fittings are simple, munitions grade, but the construction is sturdy and the blade as threatening \
	as any."
	icon_state = "isaber"
...
/obj/item/rogueweapon/sword/sabre
	name = "sabre"
	desc = "A very popular backsword made for cavalrymen that originated in Yoheon and spread its influence further north, reaching Greencrest as a \"Szablya\" and notoriously cementing itself as the preferred weapon of the Crestborne's Hussars."
	icon_state = "saber"
	sheathe_icon = "saber"
	possible_item_intents = list(/datum/intent/sword/cut/sabre, /datum/intent/sword/thrust/sabre, /datum/intent/sword/peel, /datum/intent/sword/strike)
	gripped_intents = null
...
/obj/item/rogueweapon/sword/sabre/nockhopesh
	...
	desc = "A sickle-shaped sword of southern Zybantium origin that owes its design to a type of battle axe its ancient settlers once used - it represents a symbol of power and conquest. This one in particular is made of blued steel."
...
/obj/item/rogueweapon/sword/long/shotel
	...
	icon = 'icons/roguetown/weapons/64.dmi'
	desc = "A long curved blade of Zybanti Design."

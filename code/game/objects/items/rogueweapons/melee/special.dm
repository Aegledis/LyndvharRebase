...
/obj/item/rogueweapon/katar/punchdagger
	name = "punch dagger"
	desc = "A weapon that combines the ergonomics of the Zybantu katar with the capabilities of the eastern Yoheonic \"knight-killers\". It can be tied around the wrist."

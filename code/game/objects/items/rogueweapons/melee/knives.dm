...
/obj/item/rogueweapon/huntingknife/idagger/steel/holysee
	...
	desc = "A blade forged from the Holy metals of the twinned gods Noc and Astrata, Silver and Gold fused under an Eclipse and blessed, these daggers are very grudgingly given out by the Mother Church to ordained Priests of the Ten."
	force = 25
	max_integrity = 200
	icon_state = "gsdagger"

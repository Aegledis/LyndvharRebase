						...
						if(A)
							...
							if(!do_after(user,ow, target = target))
								if(ismob(A))
									...
									GLOB.lynd_round_stats[STATS_FISH_CAUGHT]++
...
/obj/item/rogueweapon/spear/holysee
	name = "see spear"
	desc = "A blessed spear, wielded by the Mother Church's templars to keep the forces of evil at bay. The design is remarkably well-balanced, allowing it for effective off-handed use with a shield. The prongs seem to catch even the tiniest glimmer of daelight, magnifying it into a blinding glare. </br>'I fear no evil, my Gods, for thou art with me!'"
	icon_state = "gsspear"
...
/obj/item/rogueweapon/halberd/psyhalberd/relic
	name = "Stigmata"
	desc = "First seen in use against the orc tides of northern Valoria, these silver-tipped poleaxes - wielded by a lonesome contingent of Psydonian paladins - kept the horrors at bay for forty daes-and-nites. Long-since-recovered from the rubble, this relic now serve as a bulwark for the defenseless."
...
/obj/item/rogueweapon/greatsword/silver
	...
	desc = "A greatsword with a massive blade of pure silver. Such is favored amongst the Order of Syonica's paladins: a faith-militance that seeks to safeguard those who've taken pilgrimage towards Valoria's capital. </br>'There is no fate, but what we make for ourselves. It is not the will of Psydon that will determine Beowricke's fate.. but instead, the hope of its children.'"
...
/obj/item/rogueweapon/woodstaff/quarterstaff/silver
	...
	desc = "A quarterstaff reinforced with silver tips. Durable enough to catch avantyne to the shaft, without so much as a splinter - or so, they say."
	force = 20
	force_wielded = 27
	gripped_intents = list(/datum/intent/spear/bash/ranged/quarterstaff, /datum/intent/spear/thrust/quarterstaff)
...
/obj/item/rogueweapon/spear/naginata
	name = "Naginata"
	desc = "A traditional Saltlian polearm, combining the reach of a spear with the cutting power of a curved blade. Due to the brittle quality of Saltlian bladesmithing, weaponsmiths have adapted its blade to be easily replaceable when broken by a peg upon the end of the shaft."
	force = 16
	force_wielded = 30
...
/obj/item/rogueweapon/spear/assegai/iron
	name = "iron assegai"
	desc = "A long spear believed to have originated from the regions of Khazumia. Often pilfered from raids, the Kargradi are taught to use assegai so they can defend themselves against the Khaliphate."
	icon = 'icons/roguetown/weapons/64.dmi'
	max_integrity = 150
	max_blade_int = 150

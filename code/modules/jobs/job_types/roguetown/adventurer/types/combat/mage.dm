...
/datum/advclass/mage/spellblade
	...
	traits_applied = list(TRAIT_MAGEARMOR, TRAIT_ARCYNE_T2, TRAIT_SENTINELOFWITS)
	subclass_stats = list(
		STATKEY_STR = 2,
		STATKEY_INT = 4, // for sentinel of wits
		STATKEY_CON = 1,
		STATKEY_WIL = 1,
	)
...
/datum/outfit/job/roguetown/adventurer/spellblade/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/flashlight/flare/torch = 1, /obj/item/recipe_book/survival = 1, /obj/item/mundane/adventurer_kit = 1)
	if(H.mind)
	...
	if(H.mind)
		var/weapons = list("Longsword", "Sabre & Wooden Shield", "Messer & Wooden Shield", "Hwando") // Much smaller selection with only three swords. You will probably want to upgrade.

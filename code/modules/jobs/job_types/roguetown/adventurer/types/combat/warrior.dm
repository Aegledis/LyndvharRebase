...
/datum/outfit/job/roguetown/adventurer/sfighter/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		var/armors = list("Chainmaille Set","Iron Breastplate","Gambeson & Helmet","Light Zybanti Armor")
...
/datum/outfit/job/roguetown/adventurer/duelist/pre_equip(mob/living/carbon/human/H)
	...
	H.set_blindness(0)
	if(H.mind)
		var/weapons = list("Iron Saber","Dagger")
		var/weapon_choice = input(H, "Choose your weapon.", "TAKE UP ARMS") as anything in weapons
		switch(weapon_choice)
			if("Iron Saber")
				H.adjust_skillrank_up_to(/datum/skill/combat/swords, SKILL_LEVEL_JOURNEYMAN, TRUE)
				l_hand = /obj/item/rogueweapon/sword/iron/saber

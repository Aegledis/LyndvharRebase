...
/obj/item/clothing/suit/roguetown/shirt/dress/royal
	...
	name = "royal gown"
	desc = "An elaborate ball gown, a favoured fashion of queens and elevated nobility in Lyndhardtia."
	body_parts_covered = CHEST|GROIN|ARMS|VITALS

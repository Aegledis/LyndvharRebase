...
/obj/item/clothing/mask/rogue/lordmask/tarnished
	...
	desc = "Runes and wards, meant for daemons; the gold has somehow rusted in unnatural, impossible agony. The gold is now worthless, but that is not why the Khazumite Maktaba wear them."
	sellprice = 20
...
/obj/item/clothing/mask/rogue/facemask/steel/confessor
	name = "strange mask"
	desc = "It is said that the original version of this mask was used for obscure rituals prior to the fall of the First Empire, and now it has been repurposed as a veil for the cunning hand of the Valorian Holy See.<br> <br>Others say it is a piece of heresy, a necessary evil, capable of keeping its user safe from left-handed magicks. You can taste copper whenever you draw breath."

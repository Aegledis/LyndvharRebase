...
#define SKIN_COLOR_PLAINS_ELF "ffe0d1"         // Was DANDELION_CREEK
#define SKIN_COLOR_CRESTBORNE_ELF "fcccb3"     // Was ROSEVEIL
#define SKIN_COLOR_VALORIAN_ELF "edc6b3"       // Was AZUREGROVE
#define SKIN_COLOR_LYNDHARDTIAN_ELF "e2b9a3"   // Was ARBORSHOME
#define SKIN_COLOR_MOON_ELF "d9a284"           // Was ETRUSCAN_SWAMPS
#define SKIN_COLOR_WOOD_ELF "c9a893"           // Was ALMONDVALLE
#define SKIN_COLOR_JUNGLE_ELF "ba9882"         // Was WALNUT_WOODS
#define SKIN_COLOR_LOTUS_ELF "ac8369"          // Was SHALVINE_FORESTS 
#define SKIN_COLOR_SWAMP_ELF "9c6f52"          // Was LALVE_STEPPES
#define SKIN_COLOR_SUN_ELF "4e3729"            // Was NALEDI_COAST
#define SKIN_COLOR_DESERT_ELF "5d4c41"         // Was TIMBERBORN
#define SKIN_COLOR_KHAZUMITE_ELF "eae1C8"

//HUMEN SKIN TONES
#define SKIN_COLOR_GRENZELHOFT "fff0e9"           // Was GRENZELHOFT
#define SKIN_COLOR_LYNDHARDTIAN "ffe0d1"         // Was HAMMERHOLD
#define SKIN_COLOR_RHAENVALIAN "fcccb3"          // Was AVAR
#define SKIN_COLOR_DUNARGI "edc6b3"              // Was ROCKHILL
#define SKIN_COLOR_VALORIAN "e2b9a3"             // Was OTAVA
#define SKIN_COLOR_CALMIRIXIAN "d9a284"          // Was ETRUSCA
#define SKIN_COLOR_ATVERGIAN "c9a893"            // Was GRONN
#define SKIN_COLOR_NORTHERN_ZYBANTIUM "ba9882"   // Was GIZA
...
//HALF ELF SKIN TONES
#define SKIN_COLOR_GRENZEL_RHAENVAL "fff0e9"       // Was GRENZEL_AVAR
#define SKIN_COLOR_JUNGLE_ATVERGIAN "ffe0d1"     // Was TIMBER_GRONN
#define SKIN_COLOR_ZYBANTIA_VALORIAN "fcccb3"    // Was GIZA_AZURE
#define SKIN_COLOR_MOON_DUNARGI "edc6b3"         // Was WALNUT_STINE
#define SKIN_COLOR_PLAINS_CALMIRIXIAN "e2b9a3"   // Was ETRUSTCAN_DANDELION
#define SKIN_COLOR_KHAZUMITE_BORNE "5a4a41"       // Was NALEDI_BORN
#define SKIN_COLOR_SALVUM_LOTUS "E0D5B8"         // Was KAZE_LOTUS
#define SKIN_COLOR_PLAINS_ATVERGIAN "d9a284"     // Was ETRUSCA_LIRVAS
#define SKIN_COLOR_BASTARDBORNE "c9a893"         // Was FREE_FOLK
#define SKIN_COLOR_CRESTFALLEN "ba9882"          // Was AVAR_BORNE
#define SKIN_COLOR_ZYBANTIA_KHAZUMITE "ac8369"   // Was SHALVINE_AZURE
#define SKIN_COLOR_GRENZEL_DESERT "9c6f52"       // Was LALVE_NALEDI
#define SKIN_COLOR_KHAZUM_VALORIAN "4e3729"      // Was NALEDI_OTAVA
#define SKIN_COLOR_LYND_KHAZUMITE "5d4c41"       // Was HAMMER_GRONN

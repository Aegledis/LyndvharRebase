...
#define TRAIT_CHOSEN "Chosen of the Ten"
...
#define TRAIT_AZURENATIVE "Lyndvhar Native"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_OUTLANDER = span_info("The people of this region do not see me as one of them."),
	TRAIT_OUTLAW = span_info("The archaic systems of the MEISTER and the CASTIFICO recognize my status as an outlaw, and will not allow me to use them."),
	...
	TRAIT_TAVERN_FIGHTER = span_info("This tavern is my business, and none shall dare oppose me or skip out on payment."),
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the city of Lyndvhar, my abilities are sharper due to my routine and familiarity."),
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the grove and coasts of Lyndvhar, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_INQUISITION = span_info("I am a member of the Valorian Inquisition. I can easily identify others of my Sect at a glance."),
	TRAIT_CHOSEN = "Astrata chose you to represent her and her siblings' glory. Sol tibi benedicit.",
	...
	TRAIT_PSYDONITE = span_info("My faith protects me through sheer will. I can handle wounds better than most as a result. Healing miracles hold no sway over me and others of my faith, as apostate magic does not work on my soul."),
	...
	TRAIT_PURITAN = span_info("I lead the Sect of the Psydonic Valorian Inquisition sent here from Valoria."),
	...
	TRAIT_SEWING_EXPERT = span_greentext("I'm experienced with the arts of sewing and leathercraft. Sewing, Skincrafting, Leathercraft and Butchering can progress to Legendary levels."),
